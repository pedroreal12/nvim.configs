...
--
--
--['<Up>'] = cmp.mapping.select_prev_item(cmp_select), previous autocomplete
--['<C-k>'] = cmp.mapping.select_prev_item(cmp_select), same as ^^
--['<Down>'] = cmp.mapping.select_next_item(cmp_select), next autocomplete
...
--['<C-y>'] = cmp.mapping.confirm({ select = true }),same as ^^
